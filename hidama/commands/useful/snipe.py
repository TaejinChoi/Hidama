# Fully "borrowed" from:
# https://github.com/kamfretoz/XJ9/blob/main/meta/sniper.py
# Sorry but thank you. You're just a better coder than me.
import hikari
import lightbulb
from datetime import datetime
from lightbulb.ext import tasks

sniper = lightbulb.Plugin("Snipe", "Snipe deleted messages", include_datastore=True)
